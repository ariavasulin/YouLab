---
Topic: Complete API Reference · open-webui/open-webui · Discussion #16402
Date: 2026-02-11 Wed
References: https://github.com/open-webui/open-webui/discussions/16402
Author: athoik
Aliases:
...
1.  [API Structure & Conventions](https://github.com/open-webui/open-webui/discussions/16402#api-structure--conventions)
2.  [Authentication & Error Handling](https://github.com/open-webui/open-webui/discussions/16402#authentication--error-handling)
3.  [API Endpoint Tree](https://github.com/open-webui/open-webui/discussions/16402#api-endpoint-tree)
4.  [Chat & Session Management (/api/chats)](https://github.com/open-webui/open-webui/discussions/16402#chat--session-management-apichats)
5.  [Unified Chat Completions (/api/chat/completions)](https://github.com/open-webui/open-webui/discussions/16402#unified-chat-completions-apichatcompletions)
6.  [Completion Finalization (/api/chat/completed)](https://github.com/open-webui/open-webui/discussions/16402#completion-finalization-apichatcompleted)
7.  [File & RAG Management (/api/v1)](https://github.com/open-webui/open-webui/discussions/16402#file--rag-management-apiv1)
8.  [Model & Prompt Management](https://github.com/open-webui/open-webui/discussions/16402#model--prompt-management)
9.  [Admin & System Endpoints](https://github.com/open-webui/open-webui/discussions/16402#admin--system-endpoints)
10.  [Ollama Native Passthrough (/ollama)](https://github.com/open-webui/open-webui/discussions/16402#ollama-native-passthrough-ollama)
11.  [OpenAI Compatibility Layer (/v1)](https://github.com/open-webui/open-webui/discussions/16402#openai-compatibility-layer-v1)
12.  [Core Data Schemas](https://github.com/open-webui/open-webui/discussions/16402#core-data-schemas)
13.  [Client Flows & Best Practices](https://github.com/open-webui/open-webui/discussions/16402#client-flows--best-practices)
14.  [Appendix: Source Code References](https://github.com/open-webui/open-webui/discussions/16402#appendix-source-code-references)
15.  [Appendix: curl Examples](https://github.com/open-webui/open-webui/discussions/16402#appendix-curl-examples)
