...
warnings.warn(
    "youlab_server.agents.default is deprecated. "
    "Use AgentManager.create_agent() with TOML course configuration instead. "
    "See docs/Agent-System.md for migration guide.",
    DeprecationWarning,
    stacklevel=2,
)
from youlab_server.memory.blocks import (  # noqa: E402
...
from youlab_server.observability.tracing import Tracer  # noqa: E402
