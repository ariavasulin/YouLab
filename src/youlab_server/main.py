"""
YouLab Server - Main entry point.
...
from youlab_server.config.settings import Settings, get_settings
from youlab_server.observability.logging import configure_logging
from youlab_server.observability.tracing import get_tracer, init_tracer
...
def interactive_session(agent_name: str = "default") -> None:
    ...
    print("\nYouLab Server Interactive Session")
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="YouLab Server - Context-engineered Letta agents")
    parser.add_argument(
        "--agent",
        "-a",
        default="default",
